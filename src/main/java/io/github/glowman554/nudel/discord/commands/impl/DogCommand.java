...
public class DogCommand implements Command, SlashCommand
{
	...
	{
		SlashCommandRegister reg = new SlashCommandRegister("dog", this.get_short_help(), SlashCommandRegister.CHAT_INPUT, new SlashCommandParameter[] {});
