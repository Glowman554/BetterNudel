...
public class Timetable extends ResponseList<Timetable.Lesson>
{
	 ...
	 *
	 * @param timetable
	 *            timetable that should be sorted
	...
	/**
	 * Sorts the given timetable by all start times and returns the sorted
	 * timetable
	 *
	 * @param timetable
	 *            timetable that should be sorted
	...
	/**
	 * Sorts the given timetable by all end times and returns the sorted
	 * timetable
	 *
	 * @param timetable
	 *            timetable that should be sorted
	...
	/**
	 * Sorts the given timetable by all time unit object and returns the sorted
	 * timetable
	 *
	 * @param timetable
	 *            timetable that should be sorted
	...
	/**
	 * Sorts the given timetable by all teachers and returns the sorted
	 * timetable
	 *
	 * @param timetable
	 *            timetable that should be sorted
	...
	/**
	 * Sorts the given timetable by all subjects and returns the sorted
	 * timetable
	 *
	 * @param timetable
	 *            timetable that should be sorted
	...
	/**
	 * Sorts the given timetable by all activity types and returns the sorted
	 * timetable
	 *
	 * @param timetable
	 *            timetable that should be sorted
	...
	/**
	 * Finds a timetable by its date (basically returns itself, if the date is
	 * correct)
	 *
	 * @param date
	 *            date of the timetable you want to find
	 ...
	 *
	 * @param startTime
	 *            start time of the lesson you want to find
	 * @return the lesson
	 * @since 1.0
	 */
	 ...
	 *
	 * @param endTime
	 *            end time of the lesson you want to find
	 * @return the lesson
	 * @since 1.0
	 */
	...
	{
		return this.stream()
				.filter(lesson -> lesson.getEndTime().equals(endTime)).findAny()
				.orElse(null);
	}
	 ...
	 *
	 * @param timeUnitObject
	 *            time unit object of the lesson you want to find
	 * @return the lesson
	 * @since 1.1
	 */
	public Lesson findByTimeUnitObject(TimeUnits.TimeUnitObject timeUnitObject)
	{
		return this.stream().filter(
				lesson -> lesson.getTimeUnitObject().equals(timeUnitObject))
				.findAny().orElse(null);
	}
	 ...
	 *
	 * @param classes
	 *            classes of the lesson you want to find
	 * @return the lesson
	 * @since 1.0
	 */
	...
	{
		return this.stream()
				.filter(lesson -> lesson.getClasses().containsAll(classes))
				.findAny().orElse(null);
	}
	 ...
	 *
	 * @param teachers
	 *            teachers of the lesson you want to find
	 * @return the lesson
	 * @since 1.0
	 */
	...
	{
		return this.stream()
				.filter(lesson -> lesson.getTeachers().containsAll(teachers))
				.findAny().orElse(null);
	}
	 ...
	 *
	 * @param rooms
	 *            rooms of the lesson you want to find
	 * @return the lesson
	 * @since 1.0
	 */
	...
	{
		return this.stream()
				.filter(lesson -> lesson.getRooms().containsAll(rooms))
				.findAny().orElse(null);
	}
	 ...
	 *
	 * @param subjects
	 *            subjects of the lesson you want to find
	 * @return the lesson
	 * @since 1.0
	 */
	...
	{
		return this.stream()
				.filter(lesson -> lesson.getSubjects().containsAll(subjects))
				.findAny().orElse(null);
	}

	/**
	 * Returns a timetable, containing all lessons that have {@code code} as its
	 * code
	 *
	 * @param code
	 *            code of the lessons you want find
	 * @return the timetable
	 * @since 1.0
	 */
	public Timetable findByCode(UntisUtils.LessonCode code)
	{
		...
		this.stream().filter(lesson -> lesson.getCode().equals(code))
	...
	/**
	 * Returns a timetable, containing all lessons that have
	 * {@code activityType} as its activityType
	 *
	 * @param activityType
	 *            activity type of the lessons you want find
	 * @return the timetable
	 * @since 1.0
	 */
	public Timetable findByActivityType(String activityType)
	{
		...
		this.stream()
				.filter(lesson -> lesson.getActivityType()
						.equalsIgnoreCase(activityType.trim()))
				.forEach(timetable::add);
	 ...
	 *
	 * @param date
	 *            date of the lessons you want to search
	 * @return {@link Timetable} with lessons that have the {@code date} or a
	 *         part of it in their date
	 * @since 1.0
	 */
	...
	/**
	 * Finds lessons that have the {@code startTime} or a part of it in their
	 * start time
	 *
	 * @param startTime
	 *            start time of the lessons you want to search
	 * @return {@link Timetable} with lessons that have the {@code startTime} or
	 *         a part of it in their start time
	 * @since 1.0
	 */
	public Timetable searchByStartTime(LocalTime startTime)
	{
		...
		this.stream()
				.filter(lesson -> lesson.getStartTime()
	...
	/**
	 * Finds lessons that have the {@code endTime} or a part of it in their end
	 * time
	 *
	 * @param endTime
	 *            end time of the lessons you want to search
	 * @return {@link Timetable} with lessons that have the {@code endTime} or a
	 *         part of it in their end time
	 * @since 1.0
	 */
	public Timetable searchByEndTime(LocalTime endTime)
	{
		...
		this.stream()
				.filter(lesson -> lesson.getEndTime()
						.format(DateTimeFormatter.ofPattern("HHmmss"))
						.contains(endTime
								.format(DateTimeFormatter.ofPattern("HHmmss"))))
				.forEach(timetable::add);
	...
	/**
	 * Finds lessons that have the {@code timeUnitObject} or a part of it in
	 * their time unit object
	 *
	 * @param timeUnitObject
	 *            time unit object of the lessons you want to search
	 * @return {@link Timetable} with lessons that have the {@code endTime} or a
	 *         part of it in their end time
	 * @since 1.1
	 */
	...
	/**
	 * Finds lessons that have the {@code classesIds} or a part of it in their
	 * classes
	 *
	 * @param classes
	 *            classes of the lessons you want to search
	 * @return {@link Timetable} with lessons that have the {@code classesIds}
	 *         or a part of it in their classes ids
	 * @since 1.0
	 */
	...
	/**
	 * Finds lessons that have the {@code teacherIds} or a part of it in their
	 * teachers
	 *
	 * @param teachers
	 *            teachers of the lessons you want to search
	 * @return {@link Timetable} with lessons that have the {@code teacherIds}
	 *         or a part of it in their teacher ids
	 * @since 1.0
	 */
	...
	/**
	 * Finds lessons that have the {@code roomIds} or a part of it in their
	 * rooms
	 *
	 * @param rooms
	 *            rooms of the lessons you want to search
	 * @return {@link Timetable} with lessons that have the {@code roomIds} or a
	 *         part of it in their room ids
	 * @since 1.0
	 */
	...
	/**
	 * Finds lessons that have the {@code subjectIds} or a part of it in their
	 * subjects
	 *
	 * @param subjects
	 *            subjects of the lessons you want to search
	 * @return {@link Timetable} with lessons that have the {@code subjectIds}
	 *         or a part of it in their subject ids
	 * @since 1.0
	 */
	 ...
	 *
	 * @param code
	 *            code of the lessons you want to search
	 * @return {@link Timetable} with lessons that have the {@code code} in
	 *         their code
	 * @since 1.0
	 */
	...
	/**
	 * Finds lessons that have the {@code activityType} it in their activity
	 * type
	 *
	 * @param activityType
	 *            activity type of the lessons you want to search
	 * @return {@link Timetable} with lessons that have the {@code activityType}
	 *         in their activity type
	 * @since 1.0
	 */
	public Timetable searchByActivityType(String activityType)
	{
		...
		this.stream()
				.filter(lesson -> lesson.getActivityType().toLowerCase()
						.contains(activityType.trim().toLowerCase()))
				.forEach(timetable::add);
	...
	public void sortByTimeUnitObjects()
	{
		this.sort(Comparator
				.comparing(o -> o.getTimeUnitObject().getStartTime()));
	}
	...
	{
		this.sort((o1, o2) -> o1.getActivityType()
				.compareToIgnoreCase(o2.getActivityType()));
	}
	...
	public static class Lesson extends ResponseObject
	{
		 ...
		 * @param startTime
		 *            time when the lesson start
		 * @param endTime
		 *            time when the lesson end
		 * @param classes
		 *            classes
		 * @param teachers
		 *            teachers
		 ...
		 *            subjects
		 * @param code
		 *            code of the lesson (normally null,
		 *            {@link UntisUtils.LessonCode#CANCELLED} if the lesson is
		 *            cancelled, {@code UntisUtils.LessonCode.IRREGULAR} if e.g.
		 *            a lesson has been moved
		 * @param activityType
		 *            type of the lesson
		 * @since 1.0
		 */
		public Lesson(LocalDate date, LocalTime startTime, LocalTime endTime,
				TimeUnits.TimeUnitObject timeUnitObject, Classes classes,
				Teachers teachers, Rooms rooms, Subjects subjects,
				UntisUtils.LessonCode code, String activityType)
		{
			this.date = date;
		...
		/**
		 * Returns the lesson code (if cancelled the lesson is cancelled, if
		 * irregular the something irregular is with this lesson (it got moved
		 * or something)
		 *
