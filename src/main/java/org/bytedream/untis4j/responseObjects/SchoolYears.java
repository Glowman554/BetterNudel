...
public class SchoolYears extends ResponseList<SchoolYears.SchoolYearObject>
{
	...
	/**
	 * Sorts the given school years by all names and returns the sorted school
	 * years
	 *
	 * @param schoolYears
	 *            school years that should be sorted
	...
	/**
	 * Sorts the given school years by all start dates and returns the sorted
	 * school years
	 *
	 * @param schoolYears
	 *            school years that should be sorted
	...
	/**
	 * Sorts the given school years by all end dates and returns the sorted
	 * school years
	 *
	 * @param schoolYears
	 *            school years that should be sorted
	...
	/**
	 * Sorts the given school years by all ids and returns the sorted school
	 * years
	 *
	 * @param schoolYears
	 *            school years that should be sorted
	 ...
	 *
	 * @param name
	 *            name of the school year you want to find
	 * @return the school year
	 * @since 1.0
	 */
	public SchoolYearObject findByName(String name)
	{
		return this.stream().filter(schoolYearObject -> schoolYearObject
				.getName().equalsIgnoreCase(name.trim())).findAny()
				.orElse(null);
	}
	 ...
	 *
	 * @param startDate
	 *            start date of the school year you want to find
	 * @return the school year
	 * @since 1.0
	 */
	...
	{
		return this
				.stream().filter(schoolYearObject -> schoolYearObject
						.getStartDate().isEqual(startDate))
				.findAny().orElse(null);
	}
	 ...
	 *
	 * @param endDate
	 *            end date of the school year you want to find
	 * @return the school year
	 * @since 1.0
	 */
	 ...
	 *
	 * @param id
	 *            id of the school year you want to find
	 * @return the school year
	 * @since 1.0
	 */
	...
	{
		return this.stream()
				.filter(schoolYearObject -> schoolYearObject.getId() == id)
				.findAny().orElse(null);
	}

	/**
	 * Finds school years that have the {@code name} or a part of it in their
	 * name
	 *
	 * @param name
	 *            name of the school years you want to search
	 * @return {@link SchoolYears} with school years that have the {@code name}
	 *         or a part of it in their name
	 * @since 1.0
	 */
	public SchoolYears searchByName(String name)
	{
		...
		this.stream()
				.filter(schoolYearObject -> schoolYearObject.getName()
						.toLowerCase().contains(name.trim().toLowerCase()))
				.forEach(schoolYears::add);

		return schoolYears;
	}

	/**
	 * Finds school years that have the {@code startDate} or a part of it in
	 * their start date
	 *
	 * @param startDate
	 *            start date of the school years you want to search
	 * @return {@link SchoolYears} with school years that have the
	 *         {@code startDate} or a part of it in their start date
	 * @since 1.0
	 */
	public SchoolYears searchByStartDate(LocalDate startDate)
	{
		...
		this.stream()
				.filter(schoolYearObject -> schoolYearObject.getStartDate()
						.format(DateTimeFormatter.ofPattern("yyyyMMdd"))
						.contains(startDate.format(
	...
	/**
	 * Finds school years that have the {@code endDate} or a part of it in their
	 * end date
	 *
	 * @param endDate
	 *            end date of the school years you want to search
	 * @return {@link SchoolYears} with school years that have the
	 *         {@code endDate} or a part of it in their end date
	 * @since 1.0
	 */
	public SchoolYears searchByEndDate(LocalDate endDate)
	{
		...
		this.stream()
				.filter(schoolYearObject -> schoolYearObject.getEndDate()
						.format(DateTimeFormatter.ofPattern("yyyyMMdd"))
						.contains(endDate.format(
								DateTimeFormatter.ofPattern("yyyyMMdd"))))
				.forEach(schoolYears::add);
	 ...
	 *
	 * @param id
	 *            id of the school years you want to search
	 * @return {@link SchoolYears} with school years that have the {@code id} or
	 *         a part of it in their id
	 * @since 1.0
	 */
	public SchoolYears searchById(int id)
	{
		...
		this.stream().filter(schoolYearObject -> String
				.valueOf(schoolYearObject.getId()).contains(String.valueOf(id)))
				.forEach(schoolYears::add);
	...
	public ArrayList<LocalDate> getStartDates()
	{
		...
		this.stream().map(SchoolYearObject::getStartDate)
				.forEach(startDates::add);
	...
	public static class SchoolYearObject extends ResponseObject
	{
		 ...
		 * @param startDate
		 *            date when the school year began
		 * @param endDate
		 *            date when the school year will end
		 * @since 1.0
		 */
		public SchoolYearObject(String name, int id, LocalDate startDate,
				LocalDate endDate)
		{
			this.name = name;
			this.id = id;
