...
public class Rooms extends NAILResponseList<Rooms.RoomObject>
{
	 ...
	 *
	 * @param building
	 *            name of the building you want to find
	 * @return the building
	 * @since 1.0
	 */
	...
	{
		return this.stream()
				.filter(roomObject -> roomObject.getBuilding()
						.equalsIgnoreCase(building.trim()))
				.findAny().orElse(null);
	}

	/**
	 * Finds buildings that have the {@code building} name or a part of it in
	 * their name
	 *
	 * @param building
	 *            name of the buildings you want to search
	 * @return {@link Rooms} with buildings that have the {@code building} name
	...
	public Rooms searchByBuilding(String building)
	{
		...
		this.stream()
				.filter(roomObject -> roomObject.getBuilding().toLowerCase()
	...
	{
		this.sort((o1, o2) -> o1.getBuilding()
				.compareToIgnoreCase(o2.getBuilding()));
	}
	...
	public static class RoomObject extends NAILResponseObject
	{
		 ...
		 * @param building
		 *            building in which the room is
		 * @since 1.0
		 */
		public RoomObject(String name, boolean active, int id, String longName,
				String building)
		{
