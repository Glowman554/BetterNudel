...
public class Classes extends NAILResponseList<Classes.ClassObject>
{
	 ...
	 *
	 * <p>
	 * Class to get information about a class (class is the german word for
	 * class, but because class is a constructor in like every programming
	 * language the untis team named it klass
	 * </p>
	 *
	 * @version 1.1
	 * @since 1.0
