 ...
 * @since 1.1
 */
public class WeeklyTimetable extends ArrayList<Timetable>
		implements BaseResponse
{
	 ...
	 *
	 * @param startOfWeek
	 *            start of the week of which the timetables are
	 * @param monday
	 ...
	 * @since 1.1
	 */
	public WeeklyTimetable(LocalDate startOfWeek, Timetable monday,
			Timetable tuesday, Timetable wednesday, Timetable thursday,
	 ...
	 *
	 * @param dayOfWeek
	 *            day from which you want to receive the date
	 * @return the date
	 * @since 1.1
	 */
	 ...
	 *
	 * @param dayOfWeek
	 *            day from which you want to receive the timetable
